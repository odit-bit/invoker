...
<html>
  ...
  <body>
    <header class="l">
      <span class="b">bukan</span> <span class="r">-</span>
      <span class="r">GATOT</span> 
      <span class="o">KACA</span> 
    </header>
    <section class="tc">
      <form action="{{.searchEndpoint}}">
      <input class="t" type="text" name="q" placeholder="Enter search ex: github"/>
      <br>
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>bukan GatotKaca | Search</title>
    <style>
      .is{display:inline;}
      .l{font-size:2em;font-weight:bold;text-shadow: 1px 1px 1px rgba(0,0,0,0.4);}
			.l a{text-decoration: none;}
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>bukan GatotKaca | Submit site</title>
    <style>
      .l{font-size:3em;font-weight:bold;text-align:center;text-shadow: 1px 1px 1px rgba(0,0,0,0.4);}
      .l a{text-decoration: none;}
      .r{color:red;}
